                        ...
                        <div id="quizQuesDiv<?php echo $i; ?>" style="display: none;">
                            ...
                            <table class="result_pace_table" width="100%">
                                <tr>
                                    ...
                                    <td> <p class="result_pace_main">
                                        <?php 
                                        if(isset($avgTime[$question['id']]))
                                        echo secondsToString($avgTime[$question['id']]);
                                        else{
                                            echo 0;
                                        }
                                        ?>
                                        </p><p class="result_pace_subhead">Community pace</p></td>
