<body class="quiz_body">
    ...
    if($quizModel->checkCustomQuizUserStatus($quizId,$userId)==1){
        include 'customQuizResult.php';
        exit();
    }
    ...
    $quesNo = 1;
    $time = ceil($quizInfo[1] * $size * 60);
    
    $_SESSION['custom_quiz' . $quizId] = time();
    ?>
    ...
    <div id="quiz_content">
        <div class="inner_wrapper_quiz">
            <form id="quizForm" action="/action/checkCustomQuiz.php" method="POST" onsubmit="beforeSubmit();">
                ...
                <div id="startTest" class="quiz_ques_container">
                    <ul style="width:500px; margin:auto; margin-top: 30px;list-style-type:none; font-family:Century Gothic,Century_Gothic; font-size:16px;background-color: #f2f2f2;
                        padding: 20px;">
                        <li style="min-height:30px">1. This is the <?php echo floor($time/60).":".$time%60; ?> min practice session</li>
                        <li style="min-height:30px">2. There are <?php echo $size; ?> questions in this session</li>
