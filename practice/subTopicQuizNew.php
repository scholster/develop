...
if (!$controller->getSubTopicQuizInfo()) {
    include_once '../notfound.html';
    exit();
}

$questions = $controller->getQuestions(1);
$avgTime = $controller->getQuestionAvgTime(1);
$controller->createSubTopicQuizActivity();
    ...
    <div id="quiz_content">
        <div class="inner_wrapper_quiz">
            <div class="page_header_back_quiz" style="background-image:url(/assets/img/subtopic_quiz.png); 
                ...
                <?php echo $controller->subTopicName; ?>
                <div id="timer" style="display: none;">0:0</div>
                <input type="button" class="queskey_btn" id="quiz_submit" value="Submit Answer" onclick="checkSubTopicQuizAnswer()" style="display: none;"/>
                ...
                <a class="queskey_btn" id="goBackToIndex" class="queskey_btn"
                   href="<?php echo str_replace(' ', '-', '/content/' . $subject . '/' . $controller->topicName); ?>">
                    End Quiz
                </a>
